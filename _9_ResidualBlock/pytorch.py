...
from _7_CausalMultiheadAttention.pytorch import CausalSelfAttention
from _5_SWiGLU.pytorch import SwiGLUMLP
...
class TransformerBlock(nn.Module):
    ...
    def forward(
        ...
        if use_cache:
            ...
            attention_output = self.attention(normalized_input, use_cache=False)
            new_key_value = None
